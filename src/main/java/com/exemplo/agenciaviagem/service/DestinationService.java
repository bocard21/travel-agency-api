...
public class DestinationService {
    ...
    public DestinationResponseDTO addDestination(DestinationCreateDTO dto) {
        if (destinationRepository.existsByNameAndLocation(dto.getName(), dto.getLocation())) {
            throw new IllegalArgumentException("Destino já existe com este nome e localização.");
        }
